...
import com.siyi.common.exception.file.FileNameLengthLimitExceededException;
import com.siyi.common.exception.file.FileSizeLimitExceededException;
import com.siyi.common.exception.file.InvalidExtensionException;
import com.siyi.common.utils.DateUtils;
import com.siyi.common.utils.StringUtils;
import com.siyi.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = SiYiConfig.getProfile();
    ...
    {
        int dirLastIndex = SiYiConfig.getProfile().length() + 1;
     ...
     * @param files
     */
    public static void saveMultiFile( MultipartFile[] files,String signPath) {
