package com.siyi.project.common;
...
import com.siyi.common.utils.file.MimeTypeUtils;
import com.siyi.project.common.dto.Document;

import com.siyi.project.common.dto.Result;
...
import com.siyi.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = SiYiConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = SiYiConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 本地资源路径
            String localPath = SiYiConfig.getProfile();
            // 数据库资源地址
